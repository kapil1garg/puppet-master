...
namespace Kinect2Sample
{
    ...
    public sealed partial class MainPage : Page, INotifyPropertyChanged
    {
        ...
        private float gestureDetectorListLength = 0;
        ...
        public MainPage()
        {
            ...
            for (int i = 0; i < maxBodies; ++i)
            {
                ...
                this.gestureDetectorListLength += 1;
            }
        }
        ...
        void GestureResult_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (result.Confidence > 0.8)
            {
                ...
                for (int i = 0; i < this.gestureDetectorListLength; i++)
                {
                    //Debug.WriteLine(this.gestureDetectorList[i]);


                    
                    if (this.gestureDetectorList[i].GestureRecognized)
                    {
                        Debug.WriteLine(this.gestureDetectorList[i]);
                    }
                ...
                //Debug.WriteLine(this.gestureDetectorList[0]);
                */
