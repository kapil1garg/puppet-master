...
namespace Kinect2Sample
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        private readonly string bowingGestureName = "Bow";
        private readonly string raiseGestureName = "ArmRaise";
        private readonly string lowerGestureName = "ArmLower";
        ...
        public GestureDetector(KinectSensor kinectSensor, GestureResultView gestureResultView)
        {
            ...
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.gestureDatabase))
            {
                ...
                foreach (Gesture gesture in database.AvailableGestures)
                {
                    if (gesture.Name.Equals(this.bowingGestureName))
                    {
                        this.vgbFrameSource.AddGesture(gesture);
                    }
                    else if (gesture.Name.Equals(this.raiseGestureName))
                    {
                        this.vgbFrameSource.AddGesture(gesture);
                    }
                    if (gesture.Name.Equals(this.lowerGestureName))
                    {
                        this.vgbFrameSource.AddGesture(gesture);
                    }
                }
